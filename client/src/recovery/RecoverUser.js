...
const RecoveryUser = (props) => {
    ...
    function modifyAdmin() {
        ...
        axios.post(`${process.env.REACT_APP_BASE_URL}/api/user/modify_user`, {
            ...
            setState({ ...state, snack: true, snack_msg: "User has been updated you are now redirecting to the login page...", loading: false, snack_clr: '#C4FFC2' })
            setTimeout(() => {
                ...
                <Grid item >
                    <Box minWidth={'50vh'}>
                        <Grid container spacing={2} direction='column' >
                            ...
                            <Grid item>
                                <Typography color='white' >Congo here you can add your new password.</Typography>
                            </Grid>
                            {/* <Grid item>
